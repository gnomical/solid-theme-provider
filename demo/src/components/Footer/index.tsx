...
export function Footer() {
  return (
    <footer class={styles.footer}>
      <a href="https://github.com/gnomical/solid-theme-provider" target="_blank" rel="noopener noreferrer">
      ...
      <a href="https://github.com/sponsors/gnomical" target="_blank" rel="noopener noreferrer" class={styles.sponsor}>
